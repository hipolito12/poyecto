...
<body>
    <div id="Login">
           <section id="seccion">
      <asp:Label Text="Ingrese su usuario: " runat="server"  /> &nbsp;<asp:TextBox ID="l" runat="server"></asp:TextBox> <br />
               <br />
       <asp:Label Text="Ingrese su Contraseña: " runat="server" /> <asp:TextBox ID="contrasena" runat="server" ></asp:TextBox> &nbsp;<br/>
        <br />
      <div id="botones">
